    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" id="employee_update_text">Employé</h1>
          <br>
          ...
          <form class="was-validated" action="employee" method="POST">
            ...
            <div class="form-row">
              ...
              <div class="col-md-3 mb-4 mt-4">
                <label for="validationTooltip05">Date de naissance</label>
              ...
              <div class="col-md-3 mb-4 mt-4">
                <label for="validationTooltip05">Date d'embauche</label>
              ...
              <div class="col-md-6 mb-4 mt-4">
                <label for="validationTooltipDesignation">Branche</label>
                <input type="text" class="form-control" name="branch" id="branch" value="${employee.branch.branchName}" readonly="readonly"  required>
                ...
                <div class="col-md-6 mb-4 mt-4">
                  <label for="validationTooltipDesignation">pôle</label>
                  <input type="text" class="form-control" name="department" id="department" value="${employee.department.departmentName}" readonly="readonly"  required>
                      <div class="invalid-tooltip">
             ...
             <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltip05">Direction</label>
                <input type="text" class="form-control" name="direction" id="direction" value="${employee.direction}" readonly="readonly"  required>
                <div class="invalid-tooltip">
            ...
            <button class="btn btn-secondary mt-4 mb-6" type="submit" id="employee_cancel_edit" hidden="hidden">Enregistrer</button>
            <button class="btn btn-primary mt-4 mb-6" type="button" id="employee_view_btn_text" onclick="editEmployee()">Modifier</button>
