      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-white-800">Organigramme</h1>
          </div>

          <!-- Content Row -->
          <div class="organigramme">
         	 <img src="../static/admin/img/Organigramme.jpg" alt="Organigramme"  style="width:100%; border-radius: 20px ">
          </div>
          
          <div class="telechargement">
          <a href="../static/admin/img/Organigramme.jpg"
           download="../static/admin/img/Organigramme.jpg" style="color:#EEEFEF;"><i class="fas fa-download fa-1x"></i></a>
           </div>
