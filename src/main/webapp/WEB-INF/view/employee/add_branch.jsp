    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Ajout Branche</h1>
          <br>
          ...
          <form class="was-validated" action="branch" method="POST">
            <div class="form-row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="employee_branch_add_name" name="branchName" placeholder="Nom de la branche" required>
                <div class="invalid-tooltip">
                  Veuillez entrer le nom de la branche.
                </div>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3 mt-4">
                ...
                <div class="input-group">
                  ...
                  <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" id="employee_branch_add_email" name="branchEmail"  placeholder="Email de la branche" aria-describedby="validationTooltipUsernamePrepend" required>
                  <div class="invalid-tooltip">
                    Veuillez entrer l'email de la branche.
                  </div>
                  <div class="valid-tooltip">
                    Bien!
                  </div>
              ...
              <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltipBranch"></label>           
      			 <input type="text" class="form-control" id="employee_branch_add_Location" name="branchLocation" placeholder="Location" required>
                     <div class="invalid-tooltip">
