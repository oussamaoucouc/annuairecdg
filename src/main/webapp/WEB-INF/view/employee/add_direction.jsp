    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Ajout direction</h1>
          <br>
          ...
          <form class="was-validated" action="direction" method="POST">
            <div class="form-row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="employee_direction_add_name" name="directionName" placeholder="Nom de la direction" required>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltipBranch"></label>           
      			 <input type="text" class="form-control" id="employee_direction_add_fonction" name="fonction" placeholder="fonction" required>
                     <div class="invalid-tooltip">
