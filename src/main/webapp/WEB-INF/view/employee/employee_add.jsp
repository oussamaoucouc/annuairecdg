    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Ajout employé</h1>
          <br>

          <form:form action="employee" class="was-validated" >
            <div class="form-row">
              <div class="col-md-6 mb-3">
                <label for="validationTooltip01" style="color:#464644;"></label>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationTooltip02" style="color:#464644;"></label>
            ...
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltipUsername" style="color:#464644;"></label>
                <div class="input-group">
                  ...
                  <div class="invalid-tooltip">
                    Veuillez entrer une adresse email valid.
                  </div>
                  <div class="valid-tooltip">
                    Bien!
                  </div>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltip03" style="color:#464644;"></label>
              ...
              <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltip05" style="color:#464644;"></label>
                <input type="text" class="form-control" name="mobileNo" placeholder="Télephone" required>
                <div class="invalid-tooltip">
              ...
              <div class="col-md-6 mb-4 mt-4">
                <label for="validationTooltipDesignation" style="color:#464644;"></label>
                 <input type="text" class="form-control" name="designation" placeholder="Poste" required>
              ...
              <div class="col-md-3 mb-4 mt-4">
                <label for="validationTooltip05" style="color:#464644;"></label>
                <input type="date" class="form-control" name="joinedDate" placeholder="Date d'embauche" required>
                <div class="invalid-tooltip">
                  Veuillez entrer la date d'embauche.
                </div>
                <div class="valid-tooltip">
                  Bien!
                </div>
              ...
              <div class="col-md-6 mb-4 mt-4">
                <label for="validationTooltipDesignation" style="color:#464644;"></label>
                <input type="text" class="form-control" name="branch" placeholder="Branche" required>
         
                    <div class="invalid-tooltip">
                     Veuillez entrer une branche valide.
                    </div>
                    <div class="valid-tooltip">
                      Bien!
                    </div>
                ...
                <div class="col-md-6 mb-4 mt-4">
                  <label for="validationTooltipDesignation" style="color:#464644;"></label>
                   <input type="text" class="form-control" name="department" placeholder="Pôle" required>
         
                      <div class="invalid-tooltip">
                        Veuillez entrer un pôle valide.
                      </div>
                      <div class="valid-tooltip">
                        Bien!
                      </div>
               ...
               <div class="col-md-6 mb-3 mt-4">
                <label for="validationTooltip05" style="color:#464644;"></label>
                <input type="text" class="form-control" name="direction" placeholder="Direction" required>
                <div class="invalid-tooltip">
            ...
            <button class="btn btn-primary mt-4 mb-4" type="submit" id="add_btn">Ajouter</button>
            <button class="btn btn-secondary mt-4 mb-4" type="submit">Annuler</button>
