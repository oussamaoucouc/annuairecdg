    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800" id="branch_update_text">Détails de la Branche</h1>
          <br>

          <form class="was-validated" action="branch" method="POST">
            <div class="form-row">
              <div class="col-md-12 mb-3">
                <label for="validationTooltip01">Nom de la branche</label>
            ...
            <button class="btn btn-secondary mt-4" type="submit" id="branch_cancel_edit" hidden="hidden">Enregistrer</button>
            <button class="btn btn-primary mt-4" type="button" id="branch_view_btn_text" onclick="editBranch()">Modifier</button>
