                ...
                <hr class="sidebar-divider d-none d-md-block">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="/admin/employee-direction-add">
                      <i class="fas fa fa-plus"></i>
                      <span>Ajouter une directions</span></a>
                  </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Ajout pôle</h1>
          <br>
          ...
          <form class="was-validated" action="department" method="POST">
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="departmentName" name="departmentName" placeholder="Nom du Pôle" required>
                <div class="invalid-tooltip">
                  Veuillez entrer le nom du pôle.
                </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="department_add_phoneNo" name="dphoneNo" placeholder="Numéro de téléphone" required>
                <div class="invalid-tooltip">
            ...
            <div class="form-row">
              <div class="col-md-12 mb-3 mt-4">
                ...
                <div class="input-group">
                  ...
                  <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control" id="department_add_email" name="departmentEmail" placeholder="Email" aria-describedby="validationTooltipUsernamePrepend" required>
                  <div class="invalid-tooltip">
                    Veuillez entrer l'email du pôle.
                  </div>
                  <div class="valid-tooltip">
                    Bien!
                  </div>
            ...
            <div class="form-row">
              <div class="col-md-12 mb-3 mt-4">
                ...
                <input type="text" class="form-control" id="department_add_address" name="department_address" placeholder="Adresse du Pôle" required>
                <div class="invalid-tooltip">
                  Veuillez entrer l'adresse du pôle.
                </div>
                <div class="valid-tooltip">
                  Bien!
                </div>
            ...
            <button class="btn btn-primary mt-4 mb-4" type="submit">Ajouter</button>
