    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Liste des pôles</h1>
                  ...
                  <tbody>
						<c:forEach var="department" items="${listDepartments}">
							...
							<tr>
                  	  		...
                  	  		<td><a href="viewDepartment?departmentName=${department.departmentName}" class="btn btn-info btn-icon-split">
                        	...
                        	<td><a href="deleteDepartment?departmentName=${department.departmentName}" class="btn btn-danger btn-icon-split">
                                	<span class="icon text-white-50">
