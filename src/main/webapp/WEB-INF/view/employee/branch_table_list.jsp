    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Liste des branches</h1>
						...
						<c:forEach var="branch" items="${listBranches}">
							...
							<tr>
								...
								<td>${branch.branchLocation}</td>
									<td>
								<a href="mailto:${branch.branchEmail}"style="text-align: center; color:#EEEFEF;"><i class="far fa-envelope fa-2x"></i></a>
								</td>
						

                  	  		
                  	  		<td><a href="viewBranch?branchName=${branch.branchName}" class="btn btn-info btn-icon-split">
                        	...
                        	<td><a href="deleteBranch?branchName=${branch.branchName}" class="btn btn-danger btn-icon-split">
                                	<span class="icon text-white-50">
