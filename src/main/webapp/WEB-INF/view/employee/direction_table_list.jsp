    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" style="background-image:url(../static/admin/img/cdg3.jpg); background-size : cover ;">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-white-800">Liste des directions</h1>
          ...
          <!-- DataTales Employee List -->
           <div class="card shadow mb-4" style="background-color: transparent;">
            <div class="card-header py-3" style="background-color:#628B18;opacity: 0.8;">
              <h6 style="color:white;">directions</h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
						<c:forEach var="direction" items="${listDirections}">
							...
							<tr>
								...
								<td>${direction.fonction}</td>
								<td>${direction.department.departmentName}</td>
								
                  	  		
                  	  		<td><a href="viewDirection?directionName=${direction.directionName}" class="btn btn-info btn-icon-split">
                        	...
                        	<td><a href="deleteDirection?directionName=${direction.directionName}" class="btn btn-danger btn-icon-split">
                                	<span class="icon text-white-50">
